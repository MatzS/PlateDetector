...
/**
 * Bündelt alle gefundenen Konturen (mit Hierarchie) in einer Klasse. Enthält
 * außerdem Informationen aus den vorherigen Schritten wie z.B. dem
 * Preprocessing.
 */
public class ContoursResult {
    ...
    public List<ContourElement> getNBestContours(int n) {
        return contours.stream().sorted((c1, c2) -> Double.compare(c2.totalScore, c1.totalScore)).limit(n).toList();
    }
}
